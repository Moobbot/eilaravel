import {
    phoneformat, emailformat, passwordformat, rePassword, fullnameFormat, textNull,
} from "./validate.js";
...
export function validateRegisterForm(e, id_form) {
    ...
    $(id_form)
        ...
        .each(function () {
            ...
            let val = input.val();
            number_err +=
                test_input(id_form, input, name, val) == false ? 1 : 0;
...
export function checkLogin(e, id_form) {
    ...
    $(id_form)
        ...
        .each(function () {
            ...
            let val = input.val();
            checkForm =
                test_input(id_form, input, name, input.val()) == success
                    ? success
                    : fail;
    ...
    if (checkForm == success) {
        ...
        //         pass.parent().append(
        //             '<span class="error-mes">Mật khẩu không chính xác!</span>'
        //         );
        //     }
        // } else {
