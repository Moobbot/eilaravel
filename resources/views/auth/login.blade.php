...
@section('content')
    ...
    <div class="block-login row">
        ...
        <div class="login-right col-12 col-lg-5 col-md-6">
            ...
            <form method="POST" action="{{ route('login.custom') }}" id="signin-form" class="open-form js-validateform">
                @csrf
                <div class="login-top">
                ...
                <div class="login-middle">
                    <img src="{{ asset('/uploads/logo/logo-full-428x104.png') }}" alt="Logo EI Germeny" class="img-fluid" />
