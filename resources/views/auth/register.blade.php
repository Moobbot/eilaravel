...
@section('content')
    ...
    <div class="block-login row">
        ...
        <div class="login-right col-12 col-lg-5 col-md-6">
            <form action="{{ route('register.custom') }}" method="POST" id="register-form" class="js-validateform">
                @csrf
                <div class="login-top">
                ...
                <div class="register-form">
                    ...
                    <div class="form-outline ">
                        <div class="div-input @if ($errors->has('phone')) form-warning is-invalid @endif">
                            ...
                            <input type="tel" id="registerPhone" class="form-control" placeholder="Ex:+8433445506"
                    ...
                    <div class="form-outline ">
                        <div class="div-input @if ($errors->has('password')) form-warning is-invalid @endif">
                            ...
                            <input type="password" id="registerPassword" class="form-control "
                                placeholder="{{ __('Password') }}" name="password" value="{{ old('password') }}" />
